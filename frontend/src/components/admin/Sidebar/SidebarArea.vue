...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
        <a href="#" class="">
          <span class="text-2xl font-bold text-white"><span class="text-primary">E</span>commerce</span>
        </a>
      </router-link>

      <button class="block lg:hidden text-gray-400" @click="sidebarStore.isSidebarOpen = false">
        <svg
          class="fill-current"
          width="20"
          height="18"
...
const menuGroups = ref([
  {
    menuItems: [
      ...
      },
      {
        ...
        route: '#',
        children: [
          { label: 'Products All', route: '/products/all' },
          { label: 'Create Product', route: '/products/add' }
        ]
      },
      {
        icon: `<svg
