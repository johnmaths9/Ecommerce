...
const productData = ref([
  ...
  {
    image: 'https://ecommerce-ui.com/uikit/images/items/tech/3.jpg',
    title: 'Product 3',
    price: '$199.99'
  },
  {
    image: 'https://ecommerce-ui.com/uikit/images/items/tech/4.jpg',
    title: 'Product 4',
    price: '$249.99'
  },
  {
    image: 'https://ecommerce-ui.com/uikit/images/items/tech/5.jpg',
    title: 'Product 5',
    price: '$299.99'
  },
  {
    image: 'https://ecommerce-ui.com/uikit/images/items/tech/6.jpg',
    title: 'Product 6',
    price: '$349.99'
  }
])
...
<template>
  ...
  >
  <div class="mb-3 px-7.5 justify-between gap-4 sm:flex">
      <div>
      ...
      <template v-for="(product, index) in productData" :key="index">
        ...
        >
          <div class="relative h-14 w-14 rounded-full">
            <img :src="product.image" alt="Product" class="h-full w-full object-cover rounded-full" />
          </div>

          <div class="flex flex-1 items-center justify-between">
            <div>
              <h5 class="font-medium text-black dark:text-white">{{ product.title }}</h5>
              <p class="text-sm text-black dark:text-white">{{ product.price }}</p>
            </div>
          </div>
        </RouterLink>
      </template>
